...
import { registartionUserThunk } from './thunk'

export const RegistartionScreen: FC = () => {
  ...
  const handleSendForm = useCallback(async () => {
    ...
    await dispatch(
      registartionUserThunk({
        email: watch('email'),
        password: watch('password'),
        userName: watch('userName'),
      }),
    )
  }, [dispatch, watch, trigger])
    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomContainer}>
        ...
        <View style={styles.registrationContainer}>
          <Text style={styles.registrationText}>Do you have an account?</Text>
